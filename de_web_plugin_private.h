...
//    void readAllInGroup(Group *group);
    ...
    bool SendTuyaRequest2(TaskItem &task, TaskType taskType , qint8 Dp_type, qint8 Dp_identifier , QByteArray data , qint8 Dp_type2, qint8 Dp_identifier2 , QByteArray data2 );
